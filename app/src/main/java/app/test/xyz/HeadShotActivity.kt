...
import app.test.xyz.databinding.ActivityHeadShotBinding
import com.applovin.mediation.MaxAd
import com.applovin.mediation.MaxAdListener
import com.applovin.mediation.MaxError
import com.applovin.mediation.ads.MaxInterstitialAd

class HeadShotActivity : AppCompatActivity(), MaxAdListener {
    lateinit var binding: ActivityHeadShotBinding
    private lateinit var interstitialAd: MaxInterstitialAd

    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityHeadShotBinding.inflate(layoutInflater)
