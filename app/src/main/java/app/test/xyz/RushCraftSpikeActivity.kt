...
import app.test.xyz.databinding.ActivityRushCraftSpikeBinding
...
class RushCraftSpikeActivity : AppCompatActivity(), MaxAdListener {
    private lateinit var interstitialAd: MaxInterstitialAd

    lateinit var binding: ActivityRushCraftSpikeBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityRushCraftSpikeBinding.inflate(layoutInflater)
    ...
    fun setSwitchTintColor(switchButton: Switch) {
    ...
    override fun onAdHidden(p0: MaxAd) {
        ...
        Handler().postDelayed({
            ...
            if (!binding.switch1.isChecked) {
                val customLayout =
                    LayoutInflater.from(this).inflate(R.layout.bad_popup, null)
